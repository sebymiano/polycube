...
Response create_iptables_chain_remove_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
...
Response read_iptables_dyn_opt_by_id_handler(const char *name, const Key *keys, size_t num_keys);
