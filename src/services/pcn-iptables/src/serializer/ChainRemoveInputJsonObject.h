...
///
/// </summary>
class  ChainRemoveInputJsonObject : public JsonObjectBase {
public:
  ChainRemoveInputJsonObject();
  ChainRemoveInputJsonObject(const nlohmann::json &json);
  ~ChainRemoveInputJsonObject() final = default;
  ...
  void setSport(std::string value);
  ...
  /// Destination L4 Port
  /// </summary>
  std::string getDport() const;
  void setDport(std::string value);
