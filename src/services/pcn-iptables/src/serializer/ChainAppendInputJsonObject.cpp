...
std::string ChainAppendInputJsonObject::getSport() const {
  return m_sport;
}

void ChainAppendInputJsonObject::setSport(std::string value) {
  m_sport = value;
  m_sportIsSet = true;
}
...
std::string ChainAppendInputJsonObject::getDport() const {
  return m_dport;
}

void ChainAppendInputJsonObject::setDport(std::string value) {
  m_dport = value;
  m_dportIsSet = true;
}
