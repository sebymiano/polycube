...
std::string ChainInsertInputJsonObject::getSport() const {
  return m_sport;
}

void ChainInsertInputJsonObject::setSport(std::string value) {
  m_sport = value;
  m_sportIsSet = true;
}
...
std::string ChainInsertInputJsonObject::getDport() const {
  return m_dport;
}

void ChainInsertInputJsonObject::setDport(std::string value) {
  m_dport = value;
  m_dportIsSet = true;
}
