...
Helloworld::Helloworld(const std::string name, const HelloworldJsonObject &conf, CubeType type)
...
void Helloworld::update(const HelloworldJsonObject &conf) {
  //This method updates all the object/parameter in Helloworld object specified in the conf JsonObject.
...
void Helloworld::packet_in(Ports &port, polycube::service::PacketInMetadata &md, const std::vector<uint8_t> &packet){
