...
namespace LbrpApiImpl {
  ...
  bool read_lbrp_dyn_opt_by_id(const std::string &name);
  ...
  std::string read_lbrp_service_name_by_id_0(const std::string &name, const std::string &vip, const uint16_t &vport, const ServiceProtoEnum &proto);
  ...
  bool read_lbrp_start_morpheus_by_id(const std::string &name);
  ...
  void update_lbrp_start_morpheus_by_id(const std::string &name, const bool &value);
