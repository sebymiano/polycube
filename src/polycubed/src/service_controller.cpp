...
std::unordered_map<std::string, std::shared_ptr<BaseCubeIface>> ServiceController::cubes;
std::unordered_map<std::string, std::unique_ptr<ExtIface>> ServiceController::ports_to_ifaces;
...
std::shared_ptr<BaseCubeIface> ServiceController::get_cube(const std::string &name) {
